...
- `getting-started/index.html`: the tutorial, adopting Milano in an existing iOS app with the CLI, from `milano init` to a rendered banner. Its code is checked against the SDK when it changes (see the SDK's `docs/` for the reference guides).
